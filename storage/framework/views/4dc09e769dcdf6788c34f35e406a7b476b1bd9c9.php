        ...
        <table class="table table-sm text-md">
            <tr>
                ...
                <td><input readonly class="form-control form-control-sm" name="tgldanjamkunjungan_pasienbaru"
                        id="tgldanjamkunjungan_pasienbaru" value="<?php echo e($now); ?>"></td>
            </tr>
            <tr>
                <td class="text-bold">Tanggal & Jam Pengkajian</td>
                <td><input class="form-control form-control-sm" value="<?php echo e($now); ?>"
                ...
                <td colspan="4">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input ml-2 mr-3" type="radio" name="pekerjaan_pasienbaru"
                            id="pekerjaan_pasienbaru" value="5" <?php if($pasien[0]->pekerjaan == 5): ?> checked <?php endif; ?>>
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mr-3" type="radio" name="pekerjaan_pasienbaru"
                            id="pekerjaan_pasienbaru" value="3" <?php if($pasien[0]->pekerjaan == 3): ?> checked <?php endif; ?>>
                        <label class="form-check-label" for="inlineRadio2">Wiraswasta</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input ml-2 mr-3" type="radio" name="pekerjaan_pasienbaru"
                            id="pekerjaan_pasienbaru" value="15" <?php if($pasien[0]->pekerjaan == 15): ?> checked <?php endif; ?>>
                        <label class="form-check-label" for="inlineRadio1">Pegawai
                            Swasta</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mr-3" type="radio" name="pekerjaan_pasienbaru"
                            id="pekerjaan_pasienbaru" value="11" <?php if($pasien[0]->pekerjaan == 11): ?> checked <?php endif; ?>>
                        <label class="form-check-label" for="inlineRadio2">Pensiun</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mr-3" type="radio" name="pekerjaan_pasienbaru"
                            id="pekerjaan_pasienbaru" value="6" <?php if($pasien[0]->pekerjaan == 6): ?> checked <?php endif; ?>>
                ...
                <td colspan="4">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input ml-2 mr-3" type="radio" name="agama_pasienbaru"
                            id="agama_pasienbaru" value="1" <?php if($pasien[0]->agama == 1): ?> checked <?php endif; ?>>
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <label class="form-check-label" for="inlineRadio2"
                            <?php if($pasien[0]->agama == 2): ?> checked <?php endif; ?>>Kristen</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input ml-2 mr-3" type="radio" name="agama_pasienbaru"
                            id="agama_pasienbaru" value="4">
                        <label class="form-check-label" for="inlineRadio1"
                            <?php if($pasien[0]->agama == 4): ?> checked <?php endif; ?>>Hindu</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mr-3" type="radio" name="agama_pasienbaru"
                            id="agama_pasienbaru" value="5">
                        <label class="form-check-label" for="inlineRadio2"
                            <?php if($pasien[0]->agama == 5): ?> checked <?php endif; ?>>Budha</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input mr-3" type="radio" name="agama_pasienbaru"
                            id="agama_pasienbaru" value="8" <?php if($pasien[0]->agama == 8): ?> checked <?php endif; ?>>
                        <label class="form-check-label" for="inlineRadio2">Lain -
                            lain</label>
                    </div>
                </td>
                ...
                <tr class="text-center">
                    <td>
                        <textarea readonly disabled name="tanggal_assesmen" class="form-control" id="tanggal_assesmen" cols="30"
                            rows="2"> <?php echo e($now); ?></textarea>
                    </td>

                    <td>
                        <textarea readonly disabled name="nama_perawat" class="form-control" id="nama_perawat" cols="30"
                            rows="2"><?php echo e(strtoupper(auth()->user()->name)); ?></textarea>
                        <textarea hidden name="id_perawat" id="id_perawat" cols="50" rows="10"><?php echo e(strtoupper(auth()->user()->id)); ?></textarea>
                    </td>
                    <td>
...
<?php /**PATH C:\xampp\htdocs\semerusmart3\resources\views/erm/form1.blade.php ENDPATH**/ ?>